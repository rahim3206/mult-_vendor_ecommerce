...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('settings/site'.'/'.$settings->site_favicon) }}">
    <title>
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" {{ url('admin/dashboard') }} "
                ...
                @if(isset($settings->site_logo))
                    <img src="{{ asset('settings/site/'.'/'.$settings->site_logo) }}" class="navbar-brand-img h-100"
                        alt="main_logo">
                @else
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ Request::is('vendor/categories') ? 'show' : '' }} {{ Request::is('vendor/categories/*') ? 'show' : '' }}" id="products" style="">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item {{ Request::is('vendor/categories/create') ? 'active' : '' }} ">
                                <a class="nav-link " href="{{ route('vendor.categories.create') }}">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-white font-weight-bold px-0">
                                ...
                                <span class="d-sm-inline d-none">{{ Auth::guard('vendor')->name ?? 'Guest' }}</span>
                            </a>
                        </li>
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ asset('admin_assets/img/team-2.jpg') }}"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ asset('admin_assets/img/small-logos/logo-spotify.svg') }}"
